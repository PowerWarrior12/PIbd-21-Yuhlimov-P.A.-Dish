    ...
    public abstract class BackUpAbstractLogic
    {
        public void CreateArchive(string folderName)
        {
            try
            {
                ...
                MethodInfo method =
               GetType().BaseType.GetTypeInfo().GetDeclaredMethod("SaveToXMLFile");
        ...
        {
            var records = GetList<T>(); T obj = new T();
        ...
        private void SaveToXMLFile<T>(string folderName) where T : class, new()
        {
