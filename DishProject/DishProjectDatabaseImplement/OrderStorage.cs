    ...
    public class OrderStorage : IOrderStorage
    {
        ...
        public List<OrderViewModel> GetFilteredList(OrderBindingModel model)
        {
            ...
            using (var context = new DishProjectDatabase())
            {
                ...
                (model.ClientId.HasValue && rec.ClientId == model.ClientId) || (model.FreeOrders.HasValue && model.FreeOrders.Value && (rec.Status == OrderStatus.Принят || rec.Status == OrderStatus.ТребуютсяМатериалы)) ||
